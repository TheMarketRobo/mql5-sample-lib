...
//+------------------------------------------------------------------+
//
// SAMPLE EXPERT ADVISOR — SDK INTEGRATION DEMO (MQL4)
// ====================================================
// MQL4 version. Demonstrates ROBOT (Expert Advisor) integration with
// TheMarketRobo SDK v1.1+. Requires MetaTrader 4 build 600+.
//
...
#property description "Sample EA (MQL4) — TheMarketRobo SDK integration demo (ROBOT product type)"
